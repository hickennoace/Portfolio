        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            <p className="text-slate-400 text-[15px] leading-[1.9] mb-4">
              ...
              <span className="text-slate-200 font-medium">Open University of Israel</span>{" "}
            ...
            <p className="text-slate-400 text-[15px] leading-[1.9]">
              ...
              <span className="text-slate-300 font-medium">high-pressure environments.</span>
            </p>
          </motion.div>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                {languages.map(({ lang, level }) => (
                  <div key={lang} className="flex items-center gap-1.5">
                    <span className="text-[13px] text-slate-300 font-medium">{lang}</span>
