...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="py-28 sm:py-36 px-6">
        ...
        <div className="flex flex-col gap-5">
          {experiences.map((exp, i) => (
            <motion.div
              ...
              className="group p-7 sm:p-9 rounded-2xl bg-white/[0.025] border border-white/[0.07] hover:border-blue-500/25 hover:bg-white/[0.04] transition-all duration-300"
            >
              <div className="flex items-start gap-5">
                ...
                <div
                  className={`w-11 h-11 rounded-xl flex items-center justify-center shrink-0 transition-colors duration-300 ${
                    exp.blue
                      ...
                      : "bg-slate-500/15 text-slate-400 group-hover:bg-slate-500/22"
                  }`}
                >
                  <exp.Icon size={19} strokeWidth={1.5} />
                </div>
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div>
                      ...
                      <p
                        className={`text-[13px] font-medium mt-0.5 ${
                          exp.blue ? "text-blue-400" : "text-slate-400"
                        }`}
                      >
                        {exp.company}
                      </p>
                  ...
                  {/* Description */}
                  <p className="mt-4 text-slate-400 text-[14px] leading-[1.9]">
                    {exp.description}
                  </p>
